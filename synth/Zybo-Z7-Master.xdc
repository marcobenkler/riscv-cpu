...
create_clock -add -name sys_clk_pin -period 11.111 -waveform {0 4} [get_ports { clk }];
...
##Buttons
set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { reset_n_external }]; #IO_L12N_T1_MRCC_35 Sch=btn[0]
...
##Pmod Header JE                                                                                                                  
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { uart_tx_bit }]; #IO_L4P_T0_34 Sch=je[1]						 
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { uart_rx_bit }]; #IO_L18N_T2_34 Sch=je[2]                     
